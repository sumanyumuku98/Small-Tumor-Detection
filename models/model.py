...
class DetectionModel(nn.Module):
    ...
    def __init__(self, base_model=resnet101, num_templates=1, num_objects=1):
        ...
        # print(output)
        self.model = base_model(pretrained=False)
    ...
    def forward(self, x):
        ...
        # res2 = x
#        res2arr = x.cpu().detach().numpy()
#        res2arr1 = res2arr[0,:,:,:]
#        print(res2arr1.shape)
#        res2arr1_r = res2arr1.reshape(res2arr1.shape[0], -1)
#        np.savetxt('file1.txt',res2arr1_r)
        x = self.model.layer2(x)
        res3 = x
#        res3arr = res3.cpu().detach().numpy()
#        res3arr1 = res3arr[0,:,:,:]
#        print(res3arr1.shape)
#        res3arr1_r = res3arr1.reshape(res3arr1.shape[0], -1)
#        np.savetxt('file2.txt',res3arr1_r) 
        x = self.model.layer3(x)
        res4 = x
#        res4arr = res4.cpu().detach().numpy()
#        res4arr1 = res4arr[0,:,:,:]
#        print(res4arr1.shape)
#        res4arr1_reshaped = res4arr1.reshape(res4arr1.shape[0], -1)
#        print(res4arr1_reshaped.shape)
#        np.savetxt('file3.txt',res4arr1_reshaped)
